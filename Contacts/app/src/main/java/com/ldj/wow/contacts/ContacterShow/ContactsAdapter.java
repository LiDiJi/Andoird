...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsViewHolder> {
    ...
    public void onBindViewHolder(final ContactsViewHolder holder, int position) {
        ...
        holder.index = contact.getId();
        final String Phone_number = contact.getPhoneNumber();
        ...
        if (mCallClickListener != null){
            holder.ivCall.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int position = holder.getLayoutPosition();
                    mCallClickListener.onCallClick(holder.itemView, position, Phone_number);
                }
            });
        }
        ...
        if (onMsgClickListener != null){
            holder.ivMsg.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int position = holder.getLayoutPosition();
                    onMsgClickListener.onMsgClick(holder.itemView, position, Phone_number);
                }
            });
        }
    }
